# Program to Generate LUHN Checksum 
...
if sum%10 == 0:
    ...
    multiple10 = ((sum//10)+1)*10
    checkSum = multiple10 - sum
newNum = str(num) + str(checkSum)
print('Identification Number with Checksum: ',newNum)    
